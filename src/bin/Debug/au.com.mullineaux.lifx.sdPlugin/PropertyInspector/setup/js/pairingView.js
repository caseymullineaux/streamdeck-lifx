...
function loadPairingView() {
  ...
  var content =
    ...
    "</p> \
                   <p class='leftAlign'>" +
    localization["Pairing"]["DescriptionPart2"] +
    "<span class='linkspan' onclick='window.opener.openLIFXLogin()'>" +
    localization["Pairing"]["ClickHere"] +
    "</span> " +
    localization["Pairing"]["DescriptionPart3"] +
    "</p><hr/><br/></div> \
        <div id = 'controls' ></div> ";
  ...
  function autoPairing() {
    ...
    var controls =
      ...
      localization["Pairing"]["ApprovalCodeTitle"] +
      ":</div><input type='textarea' class='approvalCode' placeholder='" +
      localization["Pairing"]["ApprovalPlaceholder"] +
      "' value='' id='authToken'>\
                               <p class='small leftAlign'>" +
      localization["Pairing"]["NotePopup"] +
      "</p><br/><div class='button' id='submit'>" +
      localization["Pairing"]["Submit"] +
      "</div> \
