...
{
    [PluginActionId("au.com.mullineaux.lifx.increasebrightness")]
    public class IncreaseBrightness : PluginBase
    {
        ...
        #endregion
        public IncreaseBrightness(SDConnection connection, InitialPayload payload) : base(connection, payload)
        {
