...
{
    [PluginActionId("au.com.mullineaux.lifx.setbrightness")]
    public class SetBright : PluginBase
    {
        ...
        #endregion
        public SetBright(SDConnection connection, InitialPayload payload) : base(connection, payload)
        {
