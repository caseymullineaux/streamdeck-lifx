...
{
    [PluginActionId("au.com.mullineaux.lifx.effectbreathe")]
    public class EffectBreathe : PluginBase
    {
        ...
        #endregion
        public EffectBreathe(SDConnection connection, InitialPayload payload) : base(connection, payload)
        {
        ...
        public override async void KeyPressed(KeyPayload payload)
        {
            using (var client = new HttpClient())
            {
                ...
                string requestUri = $"https://api.lifx.com/v1/lights/{settings.Selector}/effects/breathe";
                ...
                var state = new Payload()
                {
                    ...
                    Peak = Convert.ToDouble(settings.Peak),
            };
